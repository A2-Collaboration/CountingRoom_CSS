...
<xyGraphSettings>
    <axisSettingsList>
        ...
        <range>
            <lower>1.502184567277E12</lower>
            <upper>1.502196087277E12</upper>
        </range>
    ...
    <axisSettingsList>
        ...
        <onPrimarySide>true</onPrimarySide>
        <range>
            <lower>-9481.06162733843</lower>
            <upper>74980.77739786693</upper>
        </range>
        <scaleFont>1|Cantarell|11.0|0|GTK|1|</scaleFont>
        <showMajorGrid>false</showMajorGrid>
        <title>BEAM:SCAMON:FRQ:Sum</title>
        <titleFont>1|Cantarell|11.0|1|GTK|1|</titleFont>
    </axisSettingsList>
    <plotAreaBackColor>
        <blue>255</blue>
