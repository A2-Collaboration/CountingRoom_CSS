...
<databrowser>
    ...
    <time_axis>
        <axis>
            ...
            <min>1.38288342597E12</min>
            <max>1.38288522597E12</max>
    ...
    <pvlist>
        <pv>
            <name>MWPC:HV:CH1:VOLT:READ</name>
            <display_name>Chamber 1</display_name>
            <visible>true</visible>
            <axis>0</axis>
        ...
        <pv>
            <name>MWPC:HV:CH2:VOLT:READ</name>
            <display_name>Chamber 2</display_name>
            <visible>true</visible>
            <axis>0</axis>
            <linewidth>2</linewidth>
            <color>
